...
const styles = StyleSheet.create({
  ...
  loadingText: { color: '#D2BCB4', fontSize: 14 },
  errorText: { color: '#E5877B', fontSize: 13, textAlign: 'center' },
  screen: { flex: 1, backgroundColor: '#17090D' },
  content: { padding: 24, gap: 14 },
  header: { gap: 8, marginTop: 24 },
  eyebrow: { color: '#F1C46E', fontSize: 12, fontWeight: '700', letterSpacing: 2 },
  title: { color: '#FFF4E7', fontSize: 28, fontWeight: '800' },
  subtitle: { color: '#B99D93', lineHeight: 20 },
  ...
  filterText: { color: '#B99D93', fontSize: 12, fontWeight: '700' },
  filterTextActive: { color: '#FFF4E7' },
  tournamentBanner: {
    borderRadius: 18,
    borderWidth: 1,
    borderColor: '#4B2630',
    backgroundColor: '#2C141C',
    padding: 14,
    gap: 5,
  },
  matchCard: {
  ...
  matchTitle: { color: '#FFF4E7', fontSize: 16, fontWeight: '800' },
  matchText: { color: '#D2BCB4', lineHeight: 19, fontSize: 13 },
  ...
  bannerTitle: { color: '#FFF4E7', fontSize: 16, fontWeight: '800' },
  bannerMeta: { color: '#B99D93', fontSize: 12 },
  tableCard: {
    backgroundColor: '#221017',
    borderRadius: 20,
    padding: 16,
